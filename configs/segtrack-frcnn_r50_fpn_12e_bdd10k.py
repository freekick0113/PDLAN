...
# optimizer
#optimizer = dict(type='AdamW', lr=0.01, weight_decay=0.0001, betas=(0.9, 0.999), eps=1e-08)
optimizer = dict(type='SGD', lr=0.01, momentum=0.9, weight_decay=0.0001) # ori lr=0.01
optimizer_config = dict(grad_clip=dict(_delete_=True,max_norm=0.5, norm_type=2))
